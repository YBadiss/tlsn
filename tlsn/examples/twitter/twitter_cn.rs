...
const ROUTE: &str = "i/api/graphql/JSf0I8AZFRLzAuay4E0eZw/BirdwatchFetchAuthenticatedUserProfile?variables=%7B%7D&features=%7B%22responsive_web_birdwatch_top_contributor_enabled%22%3Atrue%2C%22responsive_web_birdwatch_mobile_nav_setting_enabled%22%3Afalse%2C%22responsive_web_birdwatch_note_limit_enabled%22%3Atrue%7D";
...
async fn main() {
    ...
    let mut file = tokio::fs::File::create("twitter_cn.json").await.unwrap();
    file.write_all(
    ...
    let mut file = tokio::fs::File::create("twitter_cn_proof.json")
        .await
        .unwrap();
